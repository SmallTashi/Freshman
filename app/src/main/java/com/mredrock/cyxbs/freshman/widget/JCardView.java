...
import com.mredrock.cyxbs.freshman.utils.Dimensions;
...
public class JCardView extends FrameLayout {
    ...
    public JCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (r < 0) {
            final int dp9 = Dimensions.dp2sp(this.getContext(), 9);
        ...
        int shadowRadius = typedArray.getDimensionPixelSize(R.styleable.JCardView_shadowRadius, Dimensions.dp2sp(this.getContext(), 15));
        typedArray.recycle();
